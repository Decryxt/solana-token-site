...
import ThawTokenAccount from "./ThawTokenAccount";
      ...
      >
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-gray-400 text-center leading-tight">
            This page will show your created tokens and allow you to revoke mint
          ...
          <div className="flex h-full">
            ...
            <div className="w-1/2 pr-6 flex flex-col justify-between items-center">
              ...
              <p className="text-gray-400 text-center mb-6 px-4">
                Manage your tokens’ security by revoking mint and freeze
                authorities with ease.
              </p>
              <button className="select-button" onClick={handleManageAuthoritiesClick}>
                Manage Authorities
              </button>
            </div>
            ...
            <div className="w-1/2 pl-6 flex flex-col justify-between items-center">
              ...
              <button className="select-button" onClick={handleShowAnalyticsClick}>
        ...
        {showAuthorityOptions && !activeAuthorityDetail && (
          <div className="flex flex-col h-full">
            <div className="flex justify-center items-center mb-6 space-x-3">
              ...
              <h2 className="text-center text-3xl font-bold">Authority Actions</h2>
            </div>
        ...
        {showAnalyticsPanel && !activeAuthorityDetail && !showAuthorityOptions && (
          <div className="flex flex-col h-full">
            <div className="flex justify-center items-center mb-6 space-x-3">
              ...
              <h2 className="text-center text-3xl font-bold">Token Analytics</h2>
            </div>
